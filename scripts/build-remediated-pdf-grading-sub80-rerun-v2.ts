...
type OutputManifest = {
  ...
  laneName: 'remediated-pdf-grading-sub80-rerun-v2'
  laneIntent: 'pass_rate_conversion'
...
const sourceOutcomesPath = path.join(manifestsRoot, 'remediated-pdf-grading-sub80-rerun.outcomes.json')
const outputManifestPath = path.join(manifestsRoot, 'remediated-pdf-grading-sub80-rerun-v2.json')
const outputSummaryPath = path.join(manifestsRoot, 'remediated-pdf-grading-sub80-rerun-v2.summary.json')
...
function toCandidate(outcome: PriorOutcome): RerunCandidate {
  ...
  return {
    ...
    heuristicReasons: [
      'rerun_remediated_sub80_rerun_v2',
      'source:remediated-pdf-grading-sub80-rerun',
...
export function buildManifest(source: PriorManifest): OutputManifest {
  ...
  return {
    ...
    sourceReportRoot: path.join(repoRoot, 'ICJIA-PDFs', 'reports', 'test-runs', 'remediated-pdf-grading-sub80-rerun'),
    laneName: 'remediated-pdf-grading-sub80-rerun-v2',
    laneIntent: 'pass_rate_conversion',
    executionPolicy: 'active',
